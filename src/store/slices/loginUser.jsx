...
export const DeleteLoginFunc = createAsyncThunk(
    ...
    async (obj, id, {dispatch}) => {
        try {
            const res = await axios.delete(`looks-project-1.herokuapp.com/api_v1/users/token/${id}`, obj)
            dispatch(setUserLogin(res))
        } catch (e) {
...
export const {setUserLogin, removeUserLogin, errorMessage} = loginSlice.actions;
